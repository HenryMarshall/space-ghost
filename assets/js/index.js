...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";var _navigation=__webpack_require__(1);var _navigation2=_interopRequireDefault(_navigation);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}(0,_navigation2.default)();

/***/ },
/* 1 */
/***/ function(module, exports, __webpack_require__) {

	"use strict";Object.defineProperty(exports,"__esModule",{value:true});exports.default=function(){(0,_jquery2.default)(window).resize(function(){var more=document.getElementById("js-navigation-more");if((0,_jquery2.default)(more).length>0){var windowWidth=(0,_jquery2.default)(window).width();var moreLeftSideToPageLeftSide=(0,_jquery2.default)(more).offset().left;var moreLeftSideToPageRightSide=windowWidth-moreLeftSideToPageLeftSide;if(moreLeftSideToPageRightSide<330){(0,_jquery2.default)("#js-navigation-more .submenu .submenu").removeClass("fly-out-right");(0,_jquery2.default)("#js-navigation-more .submenu .submenu").addClass("fly-out-left");}if(moreLeftSideToPageRightSide>330){(0,_jquery2.default)("#js-navigation-more .submenu .submenu").removeClass("fly-out-left");(0,_jquery2.default)("#js-navigation-more .submenu .submenu").addClass("fly-out-right");}}});(0,_jquery2.default)(document).ready(function(){var menuToggle=(0,_jquery2.default)("#js-mobile-menu").unbind();(0,_jquery2.default)("#js-navigation-menu").removeClass("show");menuToggle.on("click",function(e){e.preventDefault();(0,_jquery2.default)("#js-navigation-menu").slideToggle(function(){if((0,_jquery2.default)("#js-navigation-menu").is(":hidden")){(0,_jquery2.default)("#js-navigation-menu").removeAttr("style");}});});});};var _jquery=__webpack_require__(2);var _jquery2=_interopRequireDefault(_jquery);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}
