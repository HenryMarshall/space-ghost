...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";var _casper=__webpack_require__(1);var _casper2=_interopRequireDefault(_casper);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}console.log("Loaded your custom JS");

/***/ },
/* 1 */
/***/ function(module, exports, __webpack_require__) {

	'use strict';var _jquery=__webpack_require__(2);var _jquery2=_interopRequireDefault(_jquery);var _fitvids=__webpack_require__(4);var _fitvids2=_interopRequireDefault(_fitvids);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}/**
	 * Main JS file for Casper behaviours
	 */(0,_jquery2.default)(document).ready(function(){(0,_fitvids2.default)();(0,_jquery2.default)(".scroll-down").arctic_scroll();(0,_jquery2.default)(".menu-button, .nav-cover, .nav-close").on("click",function(e){e.preventDefault();(0,_jquery2.default)("body").toggleClass("nav-opened nav-closed");});});// Arctic Scroll by Paul Adam Davis
	// https://github.com/PaulAdamDavis/Arctic-Scroll
	_jquery2.default.fn.arctic_scroll=function(options){var defaults={elem:(0,_jquery2.default)(this),speed:500},allOptions=_jquery2.default.extend(defaults,options);allOptions.elem.click(function(event){event.preventDefault();var $this=(0,_jquery2.default)(this),$htmlBody=(0,_jquery2.default)('html, body'),offset=$this.attr('data-offset')?$this.attr('data-offset'):false,position=$this.attr('data-position')?$this.attr('data-position'):false,toMove;if(offset){toMove=parseInt(offset);$htmlBody.stop(true,false).animate({scrollTop:(0,_jquery2.default)(this.hash).offset().top+toMove},allOptions.speed);}else if(position){toMove=parseInt(position);$htmlBody.stop(true,false).animate({scrollTop:toMove},allOptions.speed);}else{$htmlBody.stop(true,false).animate({scrollTop:(0,_jquery2.default)(this.hash).offset().top},allOptions.speed);}});};
